...
function loadStudentProfile() {
    ...
    const url = `https://mseufportal.onrender.com/student/registration/${loggedInUser.student_id}`;
...
function sendOtp() {
    ...
    fetch('https://mseufportal.onrender.com/api/send-otp', {
        method: 'POST',
        headers: {
...
document.getElementById('changePasswordForm').addEventListener('submit', function(e) {
    ...
    fetch('https://mseufportal.onrender.com/api/change-password-student', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
